...
export default async function page() {
  ...
  const cabinsNum = cabins.length || "";
  return (
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      <div className="col-span-3">
        <h1 className="text-4xl mb-10 text-accent-400 font-medium">
          Welcome to The Cabino Agency
        </h1>
      ...
      <div className="col-span-2">
        <Image
          ...
          quality={80}
          placeholder="blur"
          alt="Family that manages The Cabino Agency"
        />
      </div>
      ...
      <div className="col-span-3">
        ...
        <div className="space-y-8">
          <p>
            Since 1962, The Cabino Agency has been a cherished family-run
          ...
          <p>
            Over the years, we&apos;ve maintained the essence of The Cabino
            Agency, blending the timeless beauty of the mountains with the
            personal touch only a family business can offer. Here, you&apos;re
            not just a guest; you&apos;re part of our extended family. So join
            us at The Cabino Agency soon, where tradition meets tranquility, and
